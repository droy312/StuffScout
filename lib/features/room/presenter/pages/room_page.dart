...
import 'package:stuff_scout/features/room/presenter/pages/widgets/container_card_widget.dart';
import 'package:stuff_scout/features/room/presenter/pages/widgets/item_card_widget.dart';
              ...
              child: TabBarView(
                children: [
                  _listOfWidgetsInGridView(List.generate(
                    10,
                    (index) {
                      return const ContainerCardWidget(containerName: 'Container Name');
                    },
                  )),
                  _listOfWidgetsInGridView(List.generate(
                    10,
